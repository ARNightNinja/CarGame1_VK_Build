	...
	var e = {
			550: (e, t, r) => {
				...
				var F = new WeakMap,
					z = function() {
						function e(t) {
							...
							! function(e, t) {
								if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
							}(this, e), M(this, "_isInitialized", !1), M(this, "_platformSdk", null), M(this, "_isPlayerAuthorized", !1), M(this, "_playerId", null), M(this, "_playerName", null), M(this, "_playerPhotos", []), M(this, "_visibilityState", null), M(this, "_localStorage", null), M(this, "_defaultStorageType", l.LOCAL_STORAGE), M(this, "_platformStorageCachedData", null), M(this, "_isBannerSupported", !1), M(this, "_interstitialState", null), M(this, "_rewardedState", null), M(this, "_bannerState", null), o = {
									writable: !0,
									value: {}
								},
								function(e, t) {
									if (t.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object")
								}(r = this, n = F), n.set(r, o);
							try {
						...
						return t = e, (r = [{
							...
							get: function() {
								if (navigator && navigator.userAgent) {
									...
									if (/android|webos|iphone|ipod|blackberry|iemobile|opera mini/i.test(e)) return f.MOBILE;
									if (/ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP)))/.test(e)) return f.TABLET
								}
								return f.DESKTOP
							}
						}, {
							...
							value: function(e, t) {
								if (t === l.LOCAL_STORAGE) {
									if (this._localStorage) {
										if (Array.isArray(e)) {
											for (var r = [], n = 0; n < e.length; n++) r.push(this._getDataFromLocalStorage(e[n]));
							...
							value: function(e, t, r) {
								if (r === l.LOCAL_STORAGE) {
									if (this._localStorage) {
										if (Array.isArray(e)) {
											for (var n = 0; n < e.length; n++) this._setDataToLocalStorage(e[n], t[n]);
											return Promise.resolve()
										}
							...
							value: function(e, t) {
								"object" === B(t) && (t = JSON.stringify(t)), this._localStorage.setItem(e, t)
							}
						}, {
							...
							value: function(e) {
								this._interstitialState === e && e !== u.FAILED || (this._interstitialState = e, this.emit(i.INTERSTITIAL_STATE_CHANGED, this._interstitialState))
							}
						}, {
							key: "_setRewardedState",
							value: function(e) {
								this._rewardedState === e && e !== s.FAILED || (this._rewardedState = e, this.emit(i.REWARDED_STATE_CHANGED, this._rewardedState))
							}
						}, {
							key: "_setBannerState",
							value: function(e) {
								this._bannerState === e && e !== c.FAILED || (this._bannerState = e, this.emit(i.BANNER_STATE_CHANGED, this._bannerState))
							}
						}, {
							key: "_createPromiseDecorator",
							value: function(e) {
								var t = new R;
								return G(this, F)[e] = t, t
							}
						}, {
							...
							value: function(e, t) {
								G(this, F)[e] && (G(this, F)[e].resolve(t), delete G(this, F)[e])
							}
						}, {
							key: "_rejectPromiseDecorator",
							value: function(e, t) {
								G(this, F)[e] && (G(this, F)[e].reject(t), delete G(this, F)[e])
							}
				...
				function ae(e, t) {
					...
					return i || (i = this._createPromiseDecorator(e), this._platformSdk.send(t, n).then((function(t) {
				...
				const ue = function(e) {
					...
					function p() {
						...
						return Q(Z(e = a.call.apply(a, [this].concat(r))), ie), $(Z(e), oe, {
							writable: !0,
							value: void 0
						}), e
					}
					return t = p, (r = [{
						...
						key: "deviceType",
						get: function() {
							if (re(this, oe)) switch (re(this, oe)) {
								case "html5_ios":
								case "html5_android":
								case "html5_mobile":
									return f.MOBILE;
						...
						value: function() {
							...
							if (!o) {
								...
								i.searchParams.has("platform") && (t = this, r = oe, n = i.searchParams.get("platform"), function(e, t, r) {
									if (t.set) t.set.call(e, r);
									else {
										if (!t.writable) throw new TypeError("attempted to set read only private field");
										t.value = r
									}
								}(t, ne(t, r, "set"), n)), x("https://unpkg.com/@vkontakte/vk-bridge/dist/browser.min.js").then((function() {
									e._platformSdk = window.vkBridge, e._platformSdk.send("VKWebAppInit").then((function() {
										"html5_android" !== re(e, oe) && "html5_ios" !== re(e, oe) || (e._isBannerSupported = !0), e._platformSdk.send("VKWebAppGetUserInfo").then((function(t) {
											t && (e._playerId = t.id, e._playerName = t.first_name + " " + t.last_name, t.photo_100 && e._playerPhotos.push(t.photo_100), t.photo_200 && e._playerPhotos.push(t.photo_200), t.photo_max_orig && e._playerPhotos.push(t.photo_max_orig))
										})).finally((function() {
											e._isInitialized = !0, e._defaultStorageType = l.PLATFORM_INTERNAL, e._resolvePromiseDecorator(h)
										}))
									}))
								}))
							}
							...
							if (r === l.PLATFORM_INTERNAL) {
								if (Array.isArray(e)) {
									for (var o = [], i = 0; i < e.length; i++) {
										...
										"string" != typeof t[i] && (a.value = JSON.stringify(t[i])), o.push(this._platformSdk.send("VKWebAppStorageSet", a))
									}
								...
								return "string" != typeof t && (u.value = JSON.stringify(t)), new Promise((function(e, t) {
						...
						value: function(e, t) {
							if (t === l.PLATFORM_INTERNAL) {
								if (Array.isArray(e)) {
									for (var r = [], n = 0; n < e.length; n++) r.push(this.setDataToStorage(e[n], "", t));
						...
						value: function(e) {
							var t = this,
								...
								n = "resize",
								o = !1;
							e && ("string" == typeof e.position && (r = e.position), "string" == typeof e.layoutType && (n = e.layoutType), "boolean" == typeof e.canClose && (o = e.canClose)), this._platformSdk.send("VKWebAppShowBannerAd", {
								banner_location: r,
								layout_type: n,
								can_close: o
							}).then((function(e) {
						...
						value: function() {
							...
							this._platformSdk.send("VKWebAppCheckNativeAds", {
								...
								e._platformSdk.send("VKWebAppShowNativeAds", {
									...
									t.result ? (e._setRewardedState(s.REWARDED), e._setRewardedState(s.CLOSED)) : e._setRewardedState(s.FAILED)
								})).catch((function() {
						...
						value: function(e) {
							...
							var t = e.groupId;
							return "string" == typeof t && (t = parseInt(t), isNaN(t)) ? Promise.reject() : te(this, ie, ae).call(this, "join_community", "VKWebAppJoinGroup", {
								group_id: t
							}).then((function() {
						...
						value: function(e) {
							var t = {};
							return e && e.link && (t.link = e.link), te(this, ie, ae).call(this, "share", "VKWebAppShare", t, "type")
						}
					}, {
						key: "createPost",
						value: function(e) {
							var t = {};
							return e && e.message && (t.message = e.message), e && e.attachments && (t.attachments = e.attachments), te(this, ie, ae).call(this, "create_post", "VKWebAppShowWallPostBox", t, "post_id")
						}
					}, {
						key: "addToHomeScreen",
						value: function() {
						...
						value: function(e) {
							...
							return "boolean" == typeof e.global && (t.global = e.global ? 1 : 0), te(this, ie, ae).call(this, "show_leaderboard_native_popup", "VKWebAppShowLeaderBoardBox", t)
						}
					}]) && K(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), p
				}(W);
				...
				function Re(e) {
					...
					return new Promise((function(r) {
						...
						e && "boolean" == typeof e.scopes && (n.scopes = e.scopes), t._platformSdk.getPlayer(n).then((function(e) {
							t._playerId = e.getUniqueID(), t._isPlayerAuthorized = "lite" !== e.getMode();
							var r = e.getName();
							"" !== r && (t._playerName = r), t._playerPhotos = [];
							var n = e.getPhoto("small"),
								o = e.getPhoto("medium"),
								i = e.getPhoto("large");
							n && t._playerPhotos.push(n), o && t._playerPhotos.push(o), i && t._playerPhotos.push(i), Ee(t, De, e)
						})).finally((function() {
							r()
						}))
					}))
				...
				const je = function(e) {
					...
					function b() {
						...
						pe(this, b);
						for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
						return be(_e(e = a.call.apply(a, [this].concat(r))), Ie), Se(_e(e), Ae, {
							writable: !0,
							value: !1
						}), Se(_e(e), De, {
							writable: !0,
					...
					return t = b, (r = [{
						...
						key: "deviceType",
						get: function() {
							if (this._platformSdk) switch (this._platformSdk.deviceInfo.type) {
								case f.DESKTOP:
									return f.DESKTOP;
								case f.MOBILE:
									return f.MOBILE;
						...
						value: function(e) {
							...
							return r || (r = this._createPromiseDecorator(y), this._isPlayerAuthorized ? Pe(this, Ie, Re).call(this, e).then((function() {
						...
						value: function(e, t) {
							...
							return t === l.PLATFORM_INTERNAL ? new Promise((function(t, n) {
								...
								} else ke(r, De) ? ke(r, De).getData().then((function(n) {
									if (r._platformStorageCachedData = n, Array.isArray(e)) {
										for (var o = [], i = 0; i < e.length; i++) {
											var a = void 0 === r._platformStorageCachedData[e[i]] ? null : r._platformStorageCachedData[e[i]];
											o.push(a)
										}
										t(o)
									} else t(void 0 === r._platformStorageCachedData[e] ? null : r._platformStorageCachedData[e])
								})).catch((function(e) {
									n(e)
								})) : n()
						...
						value: function(e, t) {
							...
							return t === l.PLATFORM_INTERNAL ? new Promise((function(t, n) {
								if (ke(r, De)) {
									...
									if (Array.isArray(e))
										for (var i = 0; i < e.length; i++) delete o[e[i]];
									else delete o[e];
									ke(r, De).setData(o).then((function() {
										r._platformStorageCachedData = o, t()
									})).catch((function(e) {
										n(e)
									}))
								} else n()
						...
						value: function() {
							...
							return t || (t = this._createPromiseDecorator(d), this._platformSdk.shortcut.showPrompt().then((function(t) {
						...
						value: function() {
							...
							return t || (t = this._createPromiseDecorator(m), this._platformSdk.feedback.canReview().then((function(t) {
						...
						value: function(e) {
							...
							if (!(ke(this, Te) && e && e.score && e.leaderboardName)) return Promise.reject();
							var r = this._getPromiseDecorator(v);
							return r || (r = this._createPromiseDecorator(v), "string" == typeof e.score && (e.score = parseInt(e.score)), ke(this, Te).setLeaderboardScore(e.leaderboardName, e.score).then((function() {
						...
						value: function(e) {
							var t = this;
							if (!this._isPlayerAuthorized) return Promise.reject();
							if (!ke(this, Te) || !e || !e.leaderboardName) return Promise.reject();
							var r = this._getPromiseDecorator(_);
							return r || (r = this._createPromiseDecorator(_), ke(this, Te).getLeaderboardPlayerEntry(e.leaderboardName).then((function(e) {
						...
						value: function(e) {
							...
							if (!r) {
								...
								"boolean" == typeof e.includeUser && (n.includeUser = e.includeUser), "string" == typeof e.quantityAround && (e.quantityAround = parseInt(e.quantityAround)), "number" == typeof e.quantityAround && (n.quantityAround = e.quantityAround), "string" == typeof e.quantityTop && (e.quantityTop = parseInt(e.quantityTop)), "number" == typeof e.quantityTop && (n.quantityTop = e.quantityTop), ke(this, Te).getLeaderboardEntries(e.leaderboardName, n).then((function(e) {
									var r = null;
									e && e.entries.length > 0 && (r = e.entries.map((function(e) {
										...
										return r && t.push(r), n && t.push(n), o && t.push(o), {
					...
					}]) && he(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), b
				}(W);
				...
				const Be = function() {
					function e(t) {
						...
						! function(e, t) {
							if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
						}(this, e), n = void 0, (r = "_platformBridge") in this ? Object.defineProperty(this, r, {
							value: n,
							enumerable: !0,
							configurable: !0,
							writable: !0
						}) : this[r] = n, this._platformBridge = t
					}
					var t, r;
					return t = e, (r = [{
						key: "initialize",
					...
					}]) && Le(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), e
				}();
				...
				const We = function(e) {
					...
					function a() {
						return Ce(this, a), i.apply(this, arguments)
					}
					return t = a, (r = [{
						key: "id",
						get: function() {
					...
					}]) && Me(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), a
				}(Be);
				...
				const qe = function(e) {
					...
					function a() {
						return He(this, a), i.apply(this, arguments)
					}
					return t = a, (r = [{
					...
					}]) && Ve(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), a
				}(Be);
				...
				var et = function(e) {
					...
					function u(e) {
						...
						return function(e, t) {
							if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
						}(this, u), (t = a.call(this, e))._platformBridge.on(i.VISIBILITY_STATE_CHANGED, (function(e) {
					...
					}]) && Ze(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), u
				}(Be);
				...
				const pt = function(e) {
					...
					return t = a, (r = [{
						...
						value: function(e, t, r) {
							...
							var i = r;
							return i || (i = this.defaultType), this._platformBridge.setDataToStorage(e, t, i).then((function() {
						...
						value: function(e, t) {
							...
							if (t) {
								var n = t[this._platformBridge.platformId];
								if (n) return this.delete(e, n)
							}
							var o = t;
							return o || (o = this.defaultType), this._platformBridge.deleteDataFromStorage(e, o).then((function() {
						...
						key: "_addToCache",
						value: function(e, t, r) {
							if (lt(this, ft)[e] || (lt(this, ft)[e] = []), Array.isArray(t))
								for (var n = 0; n < t.length; n++) lt(this, ft)[e][t[n]] = r[t[n]];
							else lt(this, ft)[e][t] = r
						}
					}, {
						...
						value: function(e, t) {
							if (lt(this, ft)[e])
								if (Array.isArray(t))
									for (var r = 0; r < t.length; r++) delete lt(this, ft)[e][t[r]];
								else delete lt(this, ft)[e][t]
						}
					}]) && ot(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), a
				}(Be);
				...
				var St = "created",
					...
					Tt = function() {
						function e(t) {
							! function(e, t) {
								if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
							}(this, e), yt(this, Dt), yt(this, At), dt(this, Et, {
								writable: !0,
								value: 0
							}), dt(this, Pt, {
								writable: !0,
						...
						return t = e, (r = [{
							...
							value: function() {
								...
								switch (gt(this, kt)) {
									case St:
									case wt:
										_t(this, Pt, gt(this, Et)), vt(this, At, It).call(this, "started"), _t(this, Ot, setInterval((function() {
											_t(e, Pt, gt(e, Pt) - 1), e.emit("time_left_changed", gt(e, Pt)), gt(e, Pt) <= 0 && (vt(e, Dt, Rt).call(e), vt(e, At, It).call(e, wt))
										}), 1e3))
								}
							}
						}, {
							key: "stop",
							value: function() {
								vt(this, Dt, Rt).call(this), vt(this, At, It).call(this, "stopped")
							}
						}]) && ht(t.prototype, r), Object.defineProperty(t, "prototype", {
							writable: !1
						}), e
					}();

				function It(e) {
					_t(this, kt, e), this.emit("state_changed", gt(this, kt))
				}

				function Rt() {
					_t(this, Pt, 0), clearInterval(gt(this, Ot))
				}
				...
				var Yt = new WeakMap,
					...
					Zt = function(e) {
						...
						function l(e) {
							...
							return function(e, t) {
								if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
							}(this, l), Ft(Mt(t = a.call(this, e)), Jt), Ft(Mt(t), qt), zt(Mt(t), Yt, {
								writable: !0,
								value: void 0
							}), zt(Mt(t), Ut, {
								writable: !0,
								...
								e === u.CLOSED && Vt(Mt(t), Ut) > 0 && Ht(Mt(t), qt, Xt).call(Mt(t)), t.emit(i.INTERSTITIAL_STATE_CHANGED, e)
						...
						return t = l, (r = [{
							...
							value: function(e) {
								if (e) {
									var t = e[this._platformBridge.platformId];
									if (void 0 !== t) return this.setMinimumDelayBetweenInterstitial(t)
								}
								var r = Lt(e),
									n = Vt(this, Ut);
								switch (r) {
									case "number":
										...
										break;
									case "string":
										if (n = parseInt(e), isNaN(n)) return
								}
								xt(this, Ut, n), Vt(this, Yt) && (Vt(this, Yt).stop(), Ht(this, qt, Xt).call(this))
							}
						}, {
							key: "showBanner",
							value: function(e) {
								...
								if (this.bannerState) switch (this.bannerState) {
									case c.LOADING:
									case c.SHOWN:
										return
								}
								this._platformBridge._setBannerState(c.LOADING), this.isBannerSupported ? this._platformBridge.showBanner(e) : this._platformBridge._setBannerState(c.FAILED)
							}
						}, {
							key: "hideBanner",
							value: function() {
							...
							value: function(e) {
								if (!Ht(this, Jt, Qt).call(this)) {
									...
									var r = !1;
									e && "boolean" == typeof e.ignoreDelay && (r = e.ignoreDelay), this._platformBridge._setInterstitialState(u.LOADING), !Vt(this, Yt) || Vt(this, Yt).state === wt || r ? this._platformBridge.showInterstitial() : this._platformBridge._setInterstitialState(u.FAILED)
								}
							}
						}, {
							key: "showRewarded",
							value: function() {
								Ht(this, Jt, Qt).call(this) || (this._platformBridge._setRewardedState(s.LOADING), this._platformBridge.showRewarded())
							}
						}]) && Bt(t.prototype, r), Object.defineProperty(t, "prototype", {
							writable: !1
						}), l
					}(Be);

				function Xt() {
					xt(this, Yt, new jt(Vt(this, Ut))), Vt(this, Yt).start()
				}

				function Qt() {
					if (this.interstitialState) switch (this.interstitialState) {
						case u.LOADING:
						case u.OPENED:
							return !0
					}
					if (this.rewardedState) switch (this.rewardedState) {
						case s.LOADING:
						case s.OPENED:
						case s.REWARDED:
							return !0
				...
				const ar = function(e) {
					...
					}]) && rr(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), a
				}(Be);
				...
				const hr = function(e) {
					...
					}]) && cr(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), a
				}(Be);
				...
				const br = function(e) {
					...
					function a() {
						return dr(this, a), i.apply(this, arguments)
					}
					return t = a, (r = [{
						key: "isSupported",
						get: function() {
					...
					}]) && mr(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), a
				}(Be);
				...
				const Cr = function(e) {
					...
					return t = y, (r = [{
						...
						key: "deviceType",
						get: function() {
							if (jr(this, Br)) switch (jr(this, Br).device.type.toLowerCase()) {
								case f.DESKTOP:
									return f.DESKTOP;
								case f.MOBILE:
									return f.MOBILE;
						...
						value: function() {
							...
							if (this._isInitialized) return Promise.resolve();
							var t = this._getPromiseDecorator(h);
							return t || (t = this._createPromiseDecorator(h), x("https://sdk.crazygames.com/crazygames-sdk-v1.js").then((function() {
								e._platformSdk = window.CrazyGames.CrazySDK.getInstance(), e._platformSdk.addEventListener("initialized", (function(t) {
									Rr(e, Br, t.userInfo), e._isInitialized = !0, e._resolvePromiseDecorator(h)
									...
									jr(e, Nr) ? (e._setRewardedState(s.REWARDED), e._setRewardedState(s.CLOSED)) : e._setInterstitialState(u.CLOSED)
								...
								})), e._defaultStorageType = l.LOCAL_STORAGE, e._isBannerSupported = !0, e._platformSdk.init()
							}))), t.promise
						}
					}, {
						key: "sendMessage",
						...
						key: "showInterstitial",
						value: function() {
							Rr(this, Nr, !1), this._platformSdk.requestAd("midgame")
						}
					}, {
						key: "showRewarded",
						value: function() {
							Rr(this, Nr, !0), this._platformSdk.requestAd("rewarded")
						}
					}]) && Er(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), y
				}(W);
				...
				const Qr = function(e) {
					...
					function c() {
						...
						Wr(this, c);
						for (var t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
						return Jr(Ur(e = a.call.apply(a, [this].concat(r))), Zr), e
					}
					return t = c, (r = [{
						key: "platformId",
						get: function() {
						...
						value: function() {
							...
							if (this._isInitialized) return Promise.resolve();
							var t = this._getPromiseDecorator(h);
							return t || (t = this._createPromiseDecorator(h), x("https://unpkg.com/@agru/sdk/dist/umd/index.min.js").then((function() {
								e._platformSdk = new AgRuSdk, e._platformSdk.on(AgRuSdkMethods.ShowCampaign, (function(t, r) {
									switch (t.type) {
										case "default":
											null === r ? t.status ? e._setInterstitialState(u.OPENED) : e._setInterstitialState(u.CLOSED) : e._setInterstitialState(u.FAILED);
											break;
										case "rewarded":
											null === r ? t.status ? e._setRewardedState(s.OPENED) : (t.reward && e._setRewardedState(s.REWARDED), e._setRewardedState(s.CLOSED)) : e._setRewardedState(s.FAILED)
									}
								}));
						...
						value: function(e) {
							...
							return r || (r = this._createPromiseDecorator(y), this._platformSdk.authorize((function(e, r) {
						...
						value: function(e, t) {
							...
							return t === l.PLATFORM_INTERNAL ? new Promise((function(t, n) {
								if (r._platformStorageCachedData) {
									...
									t(void 0 === r._platformStorageCachedData[e] ? null : r._platformStorageCachedData[e])
								} else r._isPlayerAuthorized ? r._platformSdk.getSaveData((function(o, i) {
									if (null === i) {
										if (null === o && (o = {}), r._platformStorageCachedData = o, Array.isArray(e)) {
							...
							return r === l.PLATFORM_INTERNAL ? new Promise((function(r, o) {
								if (n._isPlayerAuthorized) {
									...
									n._platformSdk.setSaveData(i, (function(e, t) {
										null === t && (n._platformStorageCachedData = i, r()), o(t)
									}))
								} else o()
							...
							return t === l.PLATFORM_INTERNAL ? new Promise((function(t, n) {
								if (r._isPlayerAuthorized) {
									...
									r._platformSdk.setSaveData(o, (function(e, i) {
										null === i && (r._platformStorageCachedData = o, t()), n(i)
									}))
								} else n()
					...
					}]) && xr(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), c
				}(W);
				...
				const pn = function(e) {
					...
					return t = f, (r = [{
						...
						value: function() {
							...
							if (!e)
								if (e = this._createPromiseDecorator(h), this._options && "string" == typeof this._options.gameId) {
									var t = this;
									window.GD_OPTIONS = {
										...
										onEvent: function(e) {
											switch (e.name) {
												case "SDK_READY":
													t._platformSdk = window.gdsdk, t._platformSdk.preloadAd("rewarded"), t._isInitialized = !0, t._resolvePromiseDecorator(h);
													break;
												case "SDK_GAME_START":
									...
									}, this._defaultStorageType = l.LOCAL_STORAGE, this._isBannerSupported = !0, x("https://html5.api.gamedistribution.com/main.min.js")
								} else this._rejectPromiseDecorator(h, w);
							return e.promise
						}
					}, {
						key: "showBanner",
						...
						value: function() {
							var e = this;
							sn(this, fn, !1), this._platformSdk ? this._platformSdk.showAd().catch((function(t) {
								e._setInterstitialState(u.FAILED)
							})) : this._setInterstitialState(u.FAILED)
						}
					}, {
						...
						value: function() {
							var e = this;
							sn(this, fn, !0), this._platformSdk ? this._platformSdk.showAd("rewarded").catch((function(t) {
								e._setRewardedState(s.FAILED)
							})) : this._setRewardedState(s.FAILED)
						}
					}]) && tn(t.prototype, r), Object.defineProperty(t, "prototype", {
						writable: !1
					}), f
				}(W);
				...
				function Rn() {
					var e = n.MOCK;
					if (this._options && this._options.forciblySetPlatformId) switch (this._options.forciblySetPlatformId) {
						case n.VK:
							e = n.VK;
							break;
						case n.YANDEX:
				...
				function jn(e) {
					return wn(this, Pn) || console.error(b), wn(this, Dn)[e] ? wn(this, Dn)[e] : wn(this, An)[e]
				}
				const Ln = function() {
					function t() {
						! function(e, t) {
							if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
						}(this, t), vn(this, In), vn(this, Tn), _n(this, Pn, {
							writable: !0,
							value: !1
						}), _n(this, kn, {
							writable: !0,
					...
					return r = t, h = [{
						...
						value: function(e) {
							var t = this;
							return wn(this, Pn) ? Promise.resolve() : (wn(this, kn) || (bn(this, kn, new R), this._options = function(e) {
								for (var t = 1; t < arguments.length; t++) {
									var r = null != arguments[t] ? arguments[t] : {};
								...
								return e
							}({}, e), Sn(this, Tn, Rn).call(this), wn(this, On).initialize().then((function() {
								wn(t, An)[o.PLATFORM] = new We(wn(t, On)), wn(t, An)[o.PLAYER] = new qe(wn(t, On)), wn(t, An)[o.GAME] = new tt(wn(t, On)), wn(t, An)[o.STORAGE] = new pt(wn(t, On)), wn(t, An)[o.ADVERTISEMENT] = new $t(wn(t, On)), wn(t, An)[o.SOCIAL] = new ar(wn(t, On)), wn(t, An)[o.DEVICE] = new hr(wn(t, On)), wn(t, An)[o.LEADERBOARD] = new br(wn(t, On)), bn(t, Pn, !0), console.log("%c InstantGamesBridge v." + t.version + " initialized. ", "background: #01A5DA; color: white"), wn(t, kn) && (wn(t, kn).resolve(), bn(t, kn, null))
							}))), wn(this, kn).promise)
						}
					}, {
						key: "overrideModule",
						value: function(t, r) {
							"object" === hn(r) && (wn(this, Dn)[t] = r, "function" == typeof r.initialize && r.initialize(e))
						}
					}], h && mn(r.prototype, h), Object.defineProperty(r, "prototype", {
						writable: !1
					}), t
				}()
			},
			258: e => {
				! function(t) {
					...
					var r = {
						...
						once: function(e, t) {
							var r = this;
							return n.originalListener = t, i(r, e).push(n), r;

							function n() {
								o.call(r, e, n), t.apply(this, arguments)
							}
						},
						off: o,
						emit: function(e, t) {
					...
					function o(e, t) {
						...
						if (arguments.length) {
							if (t) {
								if (r = i(n, e, !0)) {
									if (!(r = r.filter(a)).length) return o.call(n, e);
									n.listeners[e] = r
								}
							} else if ((r = n.listeners) && (delete r[e], !Object.keys(r).length)) return o.call(n)
						} else delete n.listeners;
						return n;
